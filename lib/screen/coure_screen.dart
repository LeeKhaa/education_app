          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Material(
                    // if isVideosSection is true then other color and else another color
                    color: isVideosSection  ? Color(0xFF674AEF) : Color(0xFF674AEF).withOpacity(.6),
                    borderRadius: BorderRadius.circular(10),
                    child: InkWell(
                      onTap: (){
                        setState(() {
                  ...
                  Material(
                    color: isVideosSection ? Color(0xFF674AEF).withOpacity(.6) : Color(0xFF674AEF),
                    borderRadius: BorderRadius.circular(10),
                    child: InkWell(
                      onTap: (){
                        setState(() {
